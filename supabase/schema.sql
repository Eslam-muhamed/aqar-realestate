...
CREATE TABLE IF NOT EXISTS public.leads (
    ...
    status TEXT NOT NULL DEFAULT 'new' CHECK (status IN ('new', 'contacted', 'meeting_scheduled', 'closed_won', 'closed_lost')),
...
CREATE POLICY "Admins and owners delete properties"
...
CREATE POLICY "Admins and assigned supervisors can view leads"
...
CREATE POLICY "Admins and assigned supervisors can update leads"
