            ...
            <div className="pt-16">
                ...
                <div className="border-b border-[#2C2C2E]">
                    <div className="max-w-[1440px] mx-auto px-6 lg:px-12 py-20">
                        <p className="text-[#00E5FF] text-xs font-medium uppercase tracking-widest mb-4">نبذة عن عقار</p>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                {[
                                    ...
                                    <div key={label} className="bg-[#1E1E1E] border border-[#2C2C2E] rounded-2xl p-6">
                                        <p className="text-white font-mono font-bold text-3xl mb-1 text-start" dir={ltr ? "ltr" : "auto"}>{value}</p>
                                        <p className="text-[#98989D] text-sm text-start">{label}</p>
                                    </div>
                                ))}
                            </div>
                        </div>
                ...
                {/* Values */}
                <div className="max-w-[1440px] mx-auto px-6 lg:px-12 py-20">
                    <h2 className="text-white text-2xl font-bold mb-10 text-start">قيمنا</h2>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {VALUES.map(({ icon: Icon, title, desc }) => (
                            <div key={title} className="bg-[#1E1E1E] border border-[#2C2C2E] rounded-2xl p-6">
                                ...
                                <h3 className="text-white font-semibold text-sm mb-2 text-start">{title}</h3>
                                <p className="text-[#98989D] text-xs leading-relaxed text-start">{desc}</p>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div className="border-t border-[#2C2C2E]">
                    <div className="max-w-[1440px] mx-auto px-6 lg:px-12 py-20">
                        <h2 className="text-white text-2xl font-bold mb-10 text-start">رحلتنا</h2>
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                            {MILESTONES.map(({ year, title, desc }) => (
                                <div key={year} className="relative ps-6 border-s-2 border-[#2C2C2E]">
                                    <div className="absolute start-[-5px] top-0 w-2.5 h-2.5 rounded-full bg-[#00E5FF]" />
                                    <p className="text-[#00E5FF] font-mono text-sm font-semibold mb-2 text-start" dir="ltr">{year}</p>
                                    <h3 className="text-white font-semibold text-sm mb-2 text-start">{title}</h3>
                                    <p className="text-[#98989D] text-xs leading-relaxed text-start">{desc}</p>
                                </div>
                            ))}
