        ...
        <div className="min-h-screen bg-aqar-base flex  text-start">
                ...
                <div className="relative z-10 flex flex-col justify-end p-12">
                    <div className="flex items-center gap-2 mb-12">
                        <div className="w-7 h-7 bg-aqar-cyan rounded-sm flex items-center justify-center">
                            <span className="text-aqar-btnText font-bold text-xs font-mono">عقار</span>
                        </div>
            ...
            <div className="w-full lg:w-[480px] flex flex-col justify-center px-8 lg:px-16">
                <div className="max-w-sm mx-auto w-full">
                    ...
                    {error && (
                        <div className="flex items-center gap-2 p-4 bg-aqar-danger/10 border border-aqar-danger/30 rounded-xl mb-6">
                            <AlertCircle size={14} className="text-aqar-danger shrink-0" />
                            <p className="text-aqar-danger text-sm">{error}</p>
                        </div>
                    )}
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                        <div>
                            ...
                            <input 
                                ...
                                className={`w-full px-4 py-3 bg-aqar-surface border ${errors.name ? 'border-aqar-danger' : 'border-aqar-border'} rounded-xl text-sm text-aqar-text placeholder-aqar-muted/50 focus:border-aqar-cyan/50 focus:outline-none`} 
                            />
                            {errors.name && <p className="text-aqar-danger text-xs mt-1">{errors.name.message}</p>}
                        </div>
                        <div>
                            ...
                            <input 
                                ...
                                className={`w-full px-4 py-3 bg-aqar-surface border ${errors.email ? 'border-aqar-danger' : 'border-aqar-border'} rounded-xl text-sm text-aqar-text placeholder-aqar-muted/50 focus:border-aqar-cyan/50 focus:outline-none text-left`} dir="ltr" 
                            />
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                className={`w-full px-4 py-3 bg-aqar-surface border ${errors.confirm ? 'border-aqar-danger' : 'border-aqar-border'} rounded-xl text-sm text-aqar-text placeholder-aqar-muted/50 focus:border-aqar-cyan/50 focus:outline-none`} 
                            />
                            {errors.confirm && <p className="text-aqar-danger text-xs mt-1">{errors.confirm.message}</p>}
                        </div>

                        <button type="submit" disabled={loading}
                            className="w-full py-3.5 bg-aqar-cyan text-aqar-btnText font-semibold text-sm rounded-xl hover:bg-aqar-cyan/90 transition-colors disabled:opacity-60 mt-2 flex items-center justify-center gap-2">
