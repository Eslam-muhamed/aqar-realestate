                ...
                <div className="border-b border-[#2C2C2E] bg-[#1E1E1E]/30">
                    <div className="max-w-[1440px] mx-auto px-6 lg:px-12 py-12">
                        <div className="flex items-end justify-between">
                            <div>
                                <h1 className="text-white text-3xl font-bold tracking-tight">العقارات المحفوظة</h1>
                ...
                <div className="max-w-[1440px] mx-auto px-6 lg:px-12 py-12">
                    {saved.length > 0 ? (
                        ...
                        <div className="flex flex-col items-center justify-center py-24 text-center">
                            ...
                            <h3 className="text-white font-semibold text-lg mb-2">لا توجد عقارات محفوظة</h3>
