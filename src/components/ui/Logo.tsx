...
export default function Logo({ className }: { className?: string }) {
    return (
        <div className={cn("flex items-center gap-2.5 shrink-0 group", className)}>
            <div className="relative flex items-center justify-center w-9 h-9 md:w-10 md:h-10 bg-gradient-to-tr from-[#00E5FF] to-[#0096C7] rounded-xl shadow-lg shadow-[#00E5FF]/20 overflow-hidden transition-transform duration-300 group-hover:scale-105">
